...
namespace App\Http\Controllers\PoliklinikController\AnakController;
...
class DashboardController extends Controller
{
    public function index(){
        ...
        */
        ...
        {
            // Admin salah satu poliklinik
            return view('poliklinik_views.anak.admin.index');
        }
        // dokter or perawat poliklinik
            ...
            && in_array($user->nip, $this->getSubDepartments())) 
        {
            $redirectPath = 'poliklinik_views.anak.' . ($user->role_id == 2 ? 'dokter' : 'perawat'). '.index';
