...
namespace App\Http\Controllers\PoliklinikController\MataController;
...
class DashboardController extends Controller
{
    public function index(){
        ...
        */
        ...
        {
            // Admin salah satu poliklinik
            return view('poliklinik_views.mata.admin.index');
        }
        // dokter or perawat poliklinik
            ...
            && in_array($user->nip, $this->getSubDepartments())) 
        {
            $redirectPath = 'poliklinik_views.mata.' . ($user->role_id == 2 ? 'dokter' : 'perawat'). '.index';
