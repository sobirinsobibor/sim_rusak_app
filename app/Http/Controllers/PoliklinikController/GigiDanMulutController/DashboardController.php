...
namespace App\Http\Controllers\PoliklinikController\GigiDanMulutController;
...
class DashboardController extends Controller
{
    public function index(){
        ...
        */
        ...
        {
            // Admin salah satu poliklinik
            return view('poliklinik_views.gigi_mulut.admin.index');
        }
        // dokter or perawat poliklinik
            ...
            && in_array($user->nip, $this->getSubDepartments())) 
        {
            $redirectPath = 'poliklinik_views.gigi_mulut.' . ($user->role_id == 2 ? 'dokter' : 'perawat'). '.index';
